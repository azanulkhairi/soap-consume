 ...
 * 2019-07-12T15:46:27.894+07:00
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "CountriesPortService",
                  wsdlLocation = "file:/D:/Workspace/SoapConsume/src/main/resources/countries.wsdl",
                  targetNamespace = "http://www.baeldung.com/springsoap/gen")
public class CountriesPortService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://www.baeldung.com/springsoap/gen", "CountriesPortService");
    public final static QName CountriesPortSoap11 = new QName("http://www.baeldung.com/springsoap/gen", "CountriesPortSoap11");
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Workspace/SoapConsume/src/main/resources/countries.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CountriesPortService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/Workspace/SoapConsume/src/main/resources/countries.wsdl");
        }
        WSDL_LOCATION = url;
    }
